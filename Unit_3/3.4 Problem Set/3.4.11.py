...
#Add your code here!
def is_a_contender(team_name, wins, loses):
    stringer = "The "
    stringer += team_name
    if wins >= 40 and loses < 20:
        stringer += " are a contender!"
    elif wins < 40 and loses >= 20:
        stringer += " are not a contender!"
    else:
        stringer += " might be a contender!"
    return stringer
