...
def find_net_force(forces):
    ...
    for force in forces:
        ...
        total_horizontal += horizontal_component
        total_vertical += vertical_component
    
    magnitude = sqrt(total_horizontal ** 2 + total_vertical ** 2)
    angle_radians = atan2(total_vertical, total_horizontal)
    angle_degrees = degrees(angle_radians)
    
    return round(magnitude, 1), round(angle_degrees, 1)
