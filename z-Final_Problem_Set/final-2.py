...
#Add your code here!
def generate_name(filename, full_name):
    ...
    first_index = ord(first_initial) - ord('A')
    last_index = ord(last_initial) - ord('A') + 26
    
    first_part = lines[first_index].strip()
    last_part = lines[last_index].strip()
    
    superhero_name = f"{first_part} {last_part}"
